...
local extension_icons = {
  ...
  [".astro"]       = { "#e37933", "md-rocket_outline"                },
  [".ts"]          = { "#519aba", "seti-tsconfig"   },  -- TypeScript
  [".tsx"]          = { "#519aba", "seti-react"   },  -- TypeScript
  ...
  [".nix"] = {"#7ebbe5", 'linux-nixos'},
  [".prisma"] = {"#7ebbe5", 'seti-prisma'},
  [".lock"]= {"#f7ca39", 'seti-lock'},
}
...
local known_filenames_icons = {
  ...
  [".env"]         = { "#d0bf41", "seti-settings"         },
  ["favicon.ico"]         = { "#d0bf41", "seti-favicon"         },
  ["makefile"]        = { "#d0bf41", "dev-gnu"              },
  ["cmakelists.txt"]  = { "#cc3e55", "md-triangle_outline"  },
  ['tailwind.css'] = {"#7ebbe5","dev-css3" },
  ['tailwind.config.js'] = {"#7ebbe5","seti-json" },
  ['tailwind.config.ts'] = {"#7ebbe5","seti-json" },
  ['package.json'] = {"#cc3e55", "seti-npm"},
  ['package-lock.json'] = {"#cc3e55", "seti-npm"},
}
