...
keymap.add({
  ["alt+o"]             = { "tab-switcher:previous-tab", "tab-switcher:tab-list" },
  ["ctrl+alt+o"]        = { "tab-switcher:previous-tab", "tab-switcher:switch-to-last-tab" },
  ["alt+shift+o"]       = { "tab-switcher:next-tab", "tab-switcher:tab-list-current-split" },
  ["ctrl+alt+shift+o"]  = { "tab-switcher:next-tab", "tab-switcher:switch-to-last-tab-in-current-split" },
})
